  ...
  return (
    <div className="not-home">
      ...
      <main className="text-center px-10 flex flex-col justify-center items-center h-screen gap-10 lg:px-96 px-10">
        <h1 className="text-5xl font-bold uppercase">blog not found</h1>
        <span>
          The blog you are looking for doesn't exist. It may have been moved or
          removed altogether. Please try searching for some other product, or
